        ...
        <div className="flex min-h-screen bg-gray-50">
            ...
            <div className="w-64 bg-white shadow-lg fixed h-full z-10">
                <div className="p-6 border-b border-gray-200">
                    <h2 className="text-xl font-bold text-gray-800">Field Portal</h2>
                </div>
            ...
            <div className="flex-1 ml-64">
                <header className="bg-white shadow-sm p-4 border-b border-gray-200">
                    <div className="flex justify-between items-center">
                        <span className="text-gray-500">Logged in as <span className="font-medium text-gray-800">Field User</span></span>
                        <form 
    onSubmit={async (e) => {
